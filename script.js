const days = [
	...
	},
	{
		...
		warmup: [
			...
			{ name: "Elbow circles", detail: "30 sec" },
			{ name: "Wrist circles", detail: "30 sec" },
			{ name: "High Knees", detail: "30 sec" },
			{ name: "Standing side stretches", detail: "30 sec/side" },
		],
		exercises: [
			{ name: "Upward Salute", detail: "30 sec"},
			{ name: "Toe Touch", detail: "30 sec"},
			{ name: "Chest Opener", detail: "30 sec"},
			{ name: "Wide Leg Bend", detail: "30 sec"},
			{ name: "Side Lunge", detail: "30 sec/side"},
			{ name: "Lunge", detail: "30 sec/side"},
			{ name: "Upward Dog", detail: "30 sec" },
			{ name: "Downward Dog", detail: "30 sec" },
			{ name: "Child's Pose", detail: "30 sec" },
			{ name: "Thunderbolt", detail: "30 sec" },
			{ name: "Pigeon Pose", detail: "30 sec/side" },
			{ name: "Seated Twist", detail: "30 sec/side" },
			{ name: "Knees to chest", detail: "30 sec" },
			{ name: "Lying Figure Four", detail: "30 sec/side" },
			{ name: "Lying Hamstring", detail: "30 sec/side" },
			{ name: "Reclined Butterfly", detail: "30 sec" },
			{ name: "Spinal Twist", detail: "30 sec/side" },
			{ name: "Quad Stretch", detail: "30 sec/side" },
			{ name: "Butterfly", detail: "30 sec" },
			{ name: "Seated Forward Fold", detail: "30 sec" },
			{ name: "Plow", detail: "30 sec" },
		],
		cooldown: [
